...
class MyBookingFragment : Fragment(), DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener {
    ...
    private fun setUpRecycler(){
        ...
        bookingAdapter = BookingAdapter(Vector<Booking>(), true, requireContext(), userId)
